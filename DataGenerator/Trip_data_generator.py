...
df = pd.read_csv('eventDataAzure/trip_data_1.csv')

df_fare= pd.read_csv('eventDataAzure/trip_fare_1.csv')


partition_id='0'
for index, row_data in df.iloc[500:100000].iterrows():
    ...
    trip_data={
            ...
            "rate_code": row_data[' rate_code'],
            "store_and_fwd_flag": "",
            "pickup_datetime": row_data[' pickup_datetime'],
            "dropoff_datetime": row_data[' dropoff_datetime'],
            "passenger_count": row_data[' passenger_count'],
            "trip_time_in_secs": row_data[' trip_time_in_secs'],
            "trip_distance": row_data[' trip_distance'],
            "pickup_longitude": row_data[' pickup_longitude'],
            "pickup_latitude": row_data[' pickup_latitude'],
            "dropoff_longitude": row_data[' dropoff_longitude'],
            "dropoff_latitude": row_data[' dropoff_latitude']
        }
    ...
    with producer:
        ...
        send_event_data_batch_with_partition_id(producer,trip_data,partition_id)
